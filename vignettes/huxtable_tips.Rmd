...
Huxtable v5.0.0 introduced some backwards compatibility breaking changes. Read about these updates [here](https://hughjonesd.github.io/whats-new-in-huxtable-5.0.0.html). The changes that impact `pharmaRTF` and its related usage were:
